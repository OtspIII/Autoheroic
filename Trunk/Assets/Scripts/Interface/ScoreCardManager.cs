        ...
        foreach (Transform child in transform)
        {
            switch (child.gameObject.name)
            {
                ...
                case "Team Two Name":
                    ...
                    break;
                case "Team One Score":
                    TeamOneScores = (ScoreScrController)child.gameObject.GetComponent("ScoreScoreController");
                    break;
                case "Team Two Score":
                    TeamTwoScores = (ScoreScrController)child.gameObject.GetComponent("ScoreScoreController");
                    break;
                case "Winner Name":
